...
class PermissionSeeder extends Seeder
{
  ...
  public function run(): void
  {
    $permissions = [
      ...
      ['name' => 'service_orders.view', 'description' => 'Ver una orden de servicio específica'],
      ['name' => 'service_orders.view_by_status', 'description' => 'Ver órdenes por estado'],
      ['name' => 'service_orders.view_by_professional', 'description' => 'Ver órdenes por profesional'],
      ['name' => 'service_orders.create', 'description' => 'Crear órdenes de servicio'],
      ['name' => 'service_orders.update', 'description' => 'Actualizar órdenes de servicio'],
      ['name' => 'service_orders.postpone', 'description' => 'Posponer órdenes de servicio'],
      ['name' => 'service_orders.accept', 'description' => 'Aceptar órdenes de servicio'],
      ['name' => 'service_orders.reject', 'description' => 'Rechazar órdenes de servicio'],
      ['name' => 'service_orders.reassign_professional', 'description' => 'Reasignar profesional'],
      ['name' => 'service_orders.delete', 'description' => 'Eliminar órdenes de servicio'],
